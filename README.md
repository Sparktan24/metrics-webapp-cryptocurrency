...
This project is a SPA (single-page application) Where you can see the top 100 ranked cryptocurrencies and filter sort them by Rank (ASC - DESC) or by price.
This app fetches data from [API](https://docs.coincap.io/).
...
Feel free to check the [issues page](https://github.com/Sparktan24/metrics-webapp-cryptocurrency/issues).
...
- API used for the data [CoinCap](https://docs.coincap.io/).
